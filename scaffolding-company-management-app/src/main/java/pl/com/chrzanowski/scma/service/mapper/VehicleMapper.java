...
@Mapper(componentModel = "spring", uses = {VehicleModelMapper.class, VehicleBrandMapper.class,
        VehicleTypeMapper.class, FuelTypeMapper.class})
public interface VehicleMapper extends EntityMapper<VehicleDTO, Vehicle> {

    @Mapping(source = "vehicleBrand.id", target = "brandId")
    @Mapping(source = "vehicleBrand.name", target = "brandName")
    ...
    @Mapping(source = "brandId", target = "vehicleBrand.id")
    @Mapping(source = "brandName", target = "vehicleBrand.name")
